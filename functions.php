...
function twentyseventeen_scripts()
{
    ...
    wp_enqueue_script('vendors-scripts', get_theme_file_uri('/compiled-scripts/vendors.min.js'), array(), '', true);
    wp_enqueue_script('all-scripts', get_theme_file_uri('/compiled-scripts/bundle.js'), array(), '', true);
}
